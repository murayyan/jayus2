<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.html">JAYUS<span>Jual Beli Ayam Kualitas Bagus</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
					<li><a href="<?php echo base_url('index.php/member/login')?>" ><i class="fa fa-user" aria-hidden="true"></i>Login</a></li>
					<li><a href="<?php echo base_url('index.php/member/register')?>" ><i class="fa fa-arrow-right" aria-hidden="true"></i>Register</a></li>
				...
				<div class="nav-top">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li ><a href="<?php echo base_url('index.php/home')?>" class="hyper "><span>Home</span></a></li>	
